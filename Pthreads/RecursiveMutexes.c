...
int main(int argc, char *argv[]) {
 ...
 //with this new kind of mutex we need the same number of locks and unlocks for our code to run smoothly!
 // if ywe have an imbalance then we may reach deadlock


  //this can be locked multiple times
